...
const active = "border-b-4 border-b-amber-400 pb-1";

const Header = () => {
  const pathname = usePathname();
  return (
    <header className="flex justify-between bg-stone-800 text-stone-400 px-12 py-4 items-center shadow-md shadow-stone-700 fixed top-0 w-full">
      <button>
        <Link href="/">
          <h1 className="text-amber-400 font-bold mr-4 md:text-2xl ">
            Setlist Circle
          </h1>
        </Link>
      </button>
